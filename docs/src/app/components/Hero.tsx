  ...
  return (
    <div className="relative flex items-center justify-center h-screen  bg-black overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-xl mx-auto px-4">
        <h1 className="font-black text-6xl md:text-8xl mb-4 leading-tight text-white">
          retomizer
        </h1>
        <p className="text-sm sm:text-lg font-thin leading-relaxed max-w-md mx-auto text-gray-200">
          Simplified state management solution for React
        </p>
        <button className="px-8 py-2 border-2 font-normal text-xl  backdrop-blur-md text-gray-300 rounded-xl mt-8 bg-transparent transition-all duration-700 ease-in-out animate-border-transition">Get Started</button>
